...
@property (nonatomic, assign) CGSize originNavigationSize;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (!self.userTableView) {
        ...
        self.originNavigationSize = self.navigationController.view.frame.size;
    ...
    naviViewFrame.size.height = self.originNavigationSize.height;
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    if (self.navigationController.viewControllers.count > 1) {
        ...
        naviViewFrame.size.height = self.view.frame.size.height;
    }else{
        naviViewFrame.size.height = self.originNavigationSize.height;
    }
