...
//    如果当前NavigationViewController是根视图， 则不需要显示返回按钮
    ...
    UMComHorizonCollectionView *collectionMenuView = [[UMComHorizonCollectionView alloc]initWithFrame:CGRectMake(40, 7, self.view.frame.size.width - 80, 35) itemCount:4];
...
- (void)horizonCollectionView:(UMComHorizonCollectionView *)collectionView reloadCell:(UMComHorizonCollectionCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    imageFrame.size.height = UMComWidthScaleBetweenCurentScreenAndiPhone6Screen(6);
    imageFrame.size.width = imageFrame.size.height * 2;
