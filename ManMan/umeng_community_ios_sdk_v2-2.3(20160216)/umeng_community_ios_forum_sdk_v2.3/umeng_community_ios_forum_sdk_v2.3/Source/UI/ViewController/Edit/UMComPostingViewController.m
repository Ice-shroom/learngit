...
//    if (!isok) {
//        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:UMComLocalizedString(@"Sorry",@"抱歉") message:UMComLocalizedString(@"标题,正文,图片三者不能同时为空",@"标题,正文,图片三者不能同时为空") delegate:nil cancelButtonTitle:UMComLocalizedString(@"OK",@"好") otherButtonTitles:nil];
//        [alertView show];
//        [self.titleTextView becomeFirstResponder];
//        return;
//    }
